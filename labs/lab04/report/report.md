...
![Название рисунка](pandoc/csl/1.png){#fig:001 width=70%}

Создаю в текущем каталоге пустой текстовый файл hello.asm с помощью утилиты touch (рис. [-@fig:002])
![Название рисунка](pandoc/csl/2.png){#fig:002 width=70%}

Открываю созданный файл в текстовом редакторе и заполняю файл, вставляя в него программу для вывода “Hello word!” 
![Название рисунка](pandoc/csl/3.png){#fig:002 width=70%}

Ввожу команду, которая скомпилирует файл hello.asm в файл. Далее проверяю с помощью утилиты ls правильность выполнения команды {#fig:003 width=70%} 
![Название рисунка](pandoc/csl/4.png){#fig:004 width=70%}

Выполняю следующую команду (рис. 2.6. Объектный файл, из которого собран этот исполняемый файл, имеет имя obj.o{#fig:005 width=70%}
![Название рисунка](pandoc/csl/5.png){#fig:005 width=70%}

Запускаю на выполнение созданный исполняемый файл hello {#fig:006 width=70%}
![Название рисунка](pandoc/csl/6.png){#fig:006 width=70%}

С помощью утилиты cp создаю в текущем каталоге копию файла hello.asm с именем lab5.asm {#fig:007 width=70%}
![Название рисунка](pandoc/csl/7.png){#fig:007 width=70%}

С помощью текстового редактора mousepad открываю файл lab5.asm и вношу изменения в программу так, чтобы она выводила мои имя и фамилию{#fig:007 width=70%}
![Название рисунка](pandoc/csl/8.png){#fig:008 width=70%}

Компилирую текст программы в объектный файл (рис. 2.10). Проверяю с помощью утилиты ls, что файл lab5.o создан{#fig:009 width=70%}
![Название рисунка](pandoc/csl/9.png){#fig:009 width=70%}

Запускаю исполняемый файл lab5, на экран действительно выводятся мои имя и фамилия {#fig:0010 width=70%}
![Название рисунка](pandoc/csl/10.png){#fig:0010 width=70%}
